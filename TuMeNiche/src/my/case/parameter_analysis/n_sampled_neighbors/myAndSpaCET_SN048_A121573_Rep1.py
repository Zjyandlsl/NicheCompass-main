...
# 源文件：/home/zhangjunyi/xiangmu/nichecompass-main/TuMeNiche/src/my/case/parameter_analysis/n_sampled_neighbors/myAndSpaCET_SN048_A121573_Rep1.ipynb


# =========================================================
# n_sampled_neighbors 单参数敏感性分析
# 功能：每次只改变 n_sampled_neighbors，其它参数保持不变；
#      每个取值重新训练 NicheCompass -> 生成 TMCN 生态位 -> 计算 ARI -> 画曲线。
# 使用方式：直接复制到对应 notebook 的一个新 Cell 运行。
# =========================================================
...
# 0. 当前数据集配置
# --------------------------
CONFIG = {'dataset_name': 'CRC_SN048_A121573_Rep1', 'input_h5ad': '/home/zhangjunyi/xiangmu/nichecompass-main/datasets/12_colorectal_cancer_CRC/12_colorectal_cancer_CRC_h5ad/SN048_A121573_Rep1.h5ad', 'gmm_threshold_csv_candidates': ['/home/zhangjunyi/xiangmu/nichecompass-main/outputs/test/colorectal_12_cancer_CRC/SN048_A121573_Rep1/SpaCET/GMM_Optimal_Threshold_Result.csv', '/home/zhangjunyi/xiangmu/nichecompass-main/outputs/colorectal_12_cancer_CRC/SN048_A121573_Rep1/SpaCET/GMM_Optimal_Threshold_Result.csv'], 'save_root': '/home/zhangjunyi/xiangmu/nichecompass-main/outputs/test/parameter_sensitivity/colorectal_12_cancer_CRC/SN048_A121573_Rep1/n_sampled_neighbors', 'file_prefix': 'SN048_A121573_Rep1', 'pathology_col_candidates': ['pathology_annotation'], 'gt_map': {'tumor': 1, 'tumor&stroma_IC med to high': 1, 'stroma_fibroblastic_IC high': 1, 'epithelium&submucosa': 0, 'non neo epithelium': 0, 'submucosa': 0, 'IC aggregregate_submucosa': 0, 'IC aggregate_submucosa': 0, 'IC aggregate connective tissue': 0}, 'n_epochs': 125, 'n_sampled_neighbors_range': [2, 4, 6, 8, 10, 12], 'seed': 42, 'local_src': '/home/zhangjunyi/xiangmu/nichecompass-main/src', 'nichenet_cache_dir': '/home/zhangjunyi/xiangmu/nichecompass-main/cache_nichenet', 'n_top_hvg': 3000, 'spatial_graph_n_neighs': 8, 'latent_key': 'nichecompass_latent', 'native_cluster_key': 'latent_leiden_0.6', 'leiden_resolution': 0.6, 'latent_node_batch_size': 128, 'low_malig_offset': 0.2, 'MIN_FC': 1.3, 'MIN_ACTIVE_SPOTS': 10, 'MIN_INTENSITY_RATIO': 1.2, 'QUIESCENT_COLD_AXIS_NUM': 6}
...
CONFIG["save_root"] = "/home/zhangjunyi/xiangmu/nichecompass-main/outputs/case/parameter_analysis/n_sampled_neighbors/SN048_A121573_Rep1"
...
def train_nichecompass(adata_model, counts_key, n_sampled_neighbors):
...
# =========================================================
# Cell 3: 主循环：遍历不同 n_sampled_neighbors 并计算 ARI
# =========================================================
...
def run_sensitivity_analysis():
    ...
    for n_neighbors in CONFIG["n_sampled_neighbors_range"]:
        print("\n" + "=" * 80)
        print(f"🚀 开始参数实验: n_sampled_neighbors = {n_neighbors}")
        print("=" * 80)
        ...
        run_dir = os.path.join(
            CONFIG["save_root"],
            f"n_sampled_neighbors_{n_neighbors}"
        )
        ...
        adata_model, model = train_nichecompass(
            ...
            counts_key=counts_key,
            n_sampled_neighbors=n_neighbors
        )
        ...
        print(
            f"✅ n_sampled_neighbors = {n_neighbors} | "
            f"ARI = {ari:.4f} | valid spots = {n_valid}"
        )

        h5ad_path = os.path.join(
            run_dir,
            f"{CONFIG['file_prefix']}_n_sampled_neighbors_{n_neighbors}.h5ad"
        )
    ...
    csv_path = os.path.join(
        CONFIG["save_root"],
        "parameter_sensitivity_n_sampled_neighbors_ARI.csv"
    )
    ...
    print("\n" + "=" * 80)
    print("🎉 n_sampled_neighbors 参数敏感性分析完成！")
    print(f"✅ 结果 CSV 已保存至: {csv_path}")
    print("=" * 80)
...
# =========================================================
# Cell 4: 读取结果 CSV 并绘制 n_sampled_neighbors - ARI 曲线
# =========================================================
...
plt.plot(
    results_df["n_sampled_neighbors"],
    results_df["ARI"],
    marker="o"
)

plt.xlabel("n_sampled_neighbors")
plt.ylabel("ARI")
plt.title(
    f"Sensitivity Analysis: n_sampled_neighbors vs ARI\n"
...
fig_path = os.path.join(
    CONFIG["save_root"],
    "ARI_curve_n_sampled_neighbors.png"
)
